...
# save losses and val_losses
np.save(os.path.join(args.output_directory, 'losses.npy'), losses)
np.save(os.path.join(args.output_directory, 'val_losses.npy'), val_losses)
